...
// Extend ChainId enum with a new time value
enum ExtendedChainId {
  ...
  GOERLI = 5,
  BSC_TESTNET = 97,
  // Add new time value for deployer
  SOLANA_MAINNET = 900, // Adjust the value as needed
  SOLANA_DEVNET = 901, // Adjust the value as needed
}
...
export const CHAIN_ICONS = {
  ...
  900: "/images/networks/base.png",
  901: "/images/networks/zksync.png",
};
